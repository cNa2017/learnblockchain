...
import {ERC20_Extend, ERC721_cna, NFTMarket2} from "../src/NFTMarketExchange_reduceGas.sol";
...
contract NFTMarketExchangeTest is Test {
    ...
    function setUp() public {
        ...
        market = new NFTMarket2(address(token), address(nft), projectSigner);
        vm.stopPrank();
    ...
    function getListingInfo(uint256 tokenId) internal view returns (address _seller, uint256 _price, bool _active) {
        ( _seller, _active, _price ) = market.listings(tokenId);
    }
    ...
    function test_RevertWhen_ListingUnownedNFT() public {
        ...
        // 期望revert，并包含错误消息
        vm.expectRevert(NFTMarket2.NotOwnerOfNFT.selector);
        market.list(tokenId, NFT_PRICE);
        vm.stopPrank();
    }
    ...
    function test_RevertWhen_BuyingUnlistedNFT() public {
        ...
        // 期望revert，并包含错误消息
        vm.expectRevert(NFTMarket2.NFTNotListedForSale.selector);
    ...
    function testListAndCancelMultipleNFTs() public {
        ...
        (, uint256 price1, bool active1) = getListingInfo(tokenId1);
        (, uint256 price2, bool active2) = getListingInfo(tokenId2);
    ...
    function test_RevertWhen_InvalidSignature() public {
        ...
        // 期望交易失败，因为签名不匹配
        vm.expectRevert(NFTMarket2.InvalidSignature.selector);
        market.permitBuy(tokenId, deadline, v, r, s);
        vm.stopPrank();
    }
    ...
    function test_RevertWhen_ExpiredSignature() public {
        ...
        vm.expectRevert(NFTMarket2.PermitExpired.selector);
